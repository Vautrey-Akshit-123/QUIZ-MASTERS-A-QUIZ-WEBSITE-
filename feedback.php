...
if ((!isset($_SESSION['username']))) {
    echo '<a href="#" class="pull-right logb btn btn-primary small-button" data-toggle="modal" data-target="#myModal" style="color:white"><span class="glyphicon glyphicon-log-in" aria-hidden="true"></span>&nbsp;<font style="font-size:18px;font-weight:bold">Login</font></a>&nbsp;';
} else {
...
<a href="index.php" class="pull-right btn logb btn-primary small-button" style="color:white"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>&nbsp;<font style="font-size:18px;font-weight:bold">Home</font></a>&nbsp;
</div></div>
...
<div class="form-group">
  ...
  <div class="col-md-6">
  <input id="username" name="username" placeholder="Enter your E-mail id" class="form-control input-md" type="username">
...
<div class="col-md-6 panel feedback-form" style="background-color:lightblue; min-height:430px;">
<h2 align="center" style="font-family:'typo'; color:black"><b>FEEDBACK</h2>
