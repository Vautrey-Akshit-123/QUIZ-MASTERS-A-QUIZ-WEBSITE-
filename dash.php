...
<title> Admin || QUIZ MASTERS</title>
...
<div class="row">
<div class="col-lg-6">
<span class="logo"><font size=10 color="yellow"><i>QUIZ MASTERS</i></font></span></div>
<?php
...
if (!(isset($_SESSION['username']))  || ($_SESSION['key']) != '54585c506829293a2d4c3b68543b316e2e7a2d277858545a36362e5f39') {
    ...
    include_once 'dbConnection.php';
    echo '<span class="pull-right top title1" ><span style="color:white"><font size=5><b><span class="glyphicon glyphicon-user" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;&nbsp;Hello,</span> <span class="log log1" style="color:lightyellow"><font size=5><b>' . $name . '&nbsp;&nbsp;|&nbsp;&nbsp;<a href="logout.php?q=account.php" style="color:lightyellow"><span class="glyphicon glyphicon-log-out" aria-hidden="true"></span>&nbsp;Logout</button></a></span>';
}
?>
...
<nav class="navbar navbar-default title1">
  <div class="container-fluid">
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="dash.php?q=0"><font size=5><b>Dashboard</a>
    </div>
...
if (@$_GET['q'] == 4 && !(@$_GET['step'])) {
    echo ' 
<div class="row">
<span class="title1" style="margin-left:30%;font-size:30px;"><b>Enter Quiz Details</b></span><br /><br />
